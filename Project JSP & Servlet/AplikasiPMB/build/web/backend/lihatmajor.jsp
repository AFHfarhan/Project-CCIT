<%-- 
    Document   : lihatmajor
    Created on : Apr 12, 2016, 11:32:27 AM
    Author     : INTELAMD
--%>
...
<html>
    <head>
        <title>View Major | Administrator</title>
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            window.location = "lihatmajor.jsp";</script>
                        <% } %>  
                        <div class="col-md-12">
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    for (int i = 0; i < data.size() - 1; i += 6) {
                                                        ...
                                                        out.print("<td><a href=ubahmajor.jsp?id=" + idmajor + " onClick='return confirm('Are You Sure Want Change This Data?...')'><i class='glyphicon glyphicon-pencil nav_icon' data-toggle='tooltip' data-placement='left' title='Edit'></i></a>");
                                                        out.print("&nbsp&nbsp&nbsp<a href=proses_HapusDataMajor.jsp?idmajorhapus=" + idmajor + " onClick=\"return confirm('Are You Sure Want Delete This Data?...')\"><i class='glyphicon glyphicon-trash nav_icon'  data-toggle='tooltip' data-placement='right' title='Delete'></i></a></td>");
                                                        out.println("</tr>");
                                                    }
                                                } catch (Exception ex) {
