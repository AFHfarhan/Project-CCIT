<%-- 
    Document   : addadmin
    Created on : Apr 7, 2016, 4:10:06 PM
            ...
            <%
                              ...
                              <% } %>  
									...
									<div class="form-body form-body-info">
                                                                            <form method="POST" action="proses_AddAdmin.jsp"  data-toggle="validator" novalidate="true" enctype="multipart/form-data">
											<div class="form-group valid-form">
                                <input type="text" class="form-control" id="inputName" value="<%
                                    String idadmin = null;
        Admin auto = new Admin();
        idadmin = auto.autoidadmin();
      out.print(idadmin);  %>" name="idadmin" readonly="" required="">
											</div>
											<div class="form-group valid-form">
												<input type="text" class="form-control" data-minlength="6" id="inputName" name="nama" placeholder="Name.." required="">
                                                                                                <span class="help-block">Nama Minimal 6 Characters</span>
											</div>
											<div class="form-group has-feedback">
												<input type="text" class="form-control"  data-minlength="6" id="inputName" name="user"  placeholder="Username.." required="">
                                                                                                <span class="help-block">Username Minimal 6 Characters</span>
											</div>
											<div class="form-group has-feedback">
                                                                                            <select name="statusadmin" id="selector1" class="form-control" required="">
												<option>Admin</option>
												<option>Staff</option>
											</select>
                                                                                        </div>
											<div class="form-group">
											  ...
											  <span class="help-block">Password Minimal 6 Characters</span>
											</div>
											<div class="form-group">
											  <input type="password" class="form-control" id="inputPasswordConfirm" data-match="#inputPassword" data-match-error="Password Not Match!" placeholder="Confirmation password.." required="">
