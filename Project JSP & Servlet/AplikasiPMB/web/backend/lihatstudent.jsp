<%-- 
    Document   : lihatstudent
    Created on : Apr 12, 2016, 10:42:09 PM
    Author     : INTELAMD
--%>
...
<html>
    <head>
        <title>View Student Data | Administrator</title>
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            window.location = "lihatstudent.jsp";</script>
                        <% } %>  
                        <div class="col-md-12">
                            <div class="panel panel-widget">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th><center>ID Student</center></th>
                                                ...
                                                <th><center>Graduation</center></th>
                                        ...
                                        <tbody>
                                            <%
                                                try {
                                                    ...
                                                    for (int i = 0; i < data.size() - 1; i += 12) {
                                                        ...
                                                        out.print("<td><img src='../backend/images_student/" + photo + "' width='30px' height='30px'></td>");
                                                        out.print("<td>");
                                                        out.print("<a href='proses_HapusDataStudent.jsp?idstudenthapus=" + idstudent + "' onClick=\"return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?...')\"><i class='glyphicon glyphicon-trash nav_icon'  data-toggle='tooltip' data-placement='left' title='Delete'></i></a></td>");
                                                        out.println("</tr>");
                                                    }
                                                } catch (Exception ex) {
